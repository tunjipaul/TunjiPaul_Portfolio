  ...
  return (
    <>
      <div
        role="dialog"
        aria-modal="true"
        aria-label="Chat with Tunji's AI assistant"
        hidden={!isOpen}
      ...
      >
        <div className="bg-gradient-to-r from-orange-600 to-orange-700 text-white p-3 md:p-4 flex justify-between items-center md:rounded-t-2xl">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div>
              <p className="font-semibold text-base md:text-lg">AI Assistant</p>
          ...
          <div className="flex gap-1 md:gap-2">
            <button
              type="button"
              onClick={clearChat}
              className="w-11 h-11 md:w-8 md:h-8 bg-white/20 hover:bg-white/30 rounded-full flex items-center justify-center transition-colors text-lg md:text-base"
              title="Clear chat"
        ...
        >
          ...
          <button
            ...
            className="w-11 h-11 rounded-full bg-gradient-to-r from-orange-600 to-orange-700 text-white flex items-center justify-center text-base md:text-lg hover:scale-105 hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
          >
            ➤
          </button>
        </form>
