...
function Hero() {
  ...
  const portraitSrc = optimizeCloudinary(hero.image_url, {
    width: 768,
    height: 768,
    crop: "fill",
  });
    ...
    >
      <div className="md:w-1/2 flex justify-center order-1 md:order-2 mb-10 md:mb-0">
        <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
          <img
            src={portraitSrc}
            alt="Tunji Paul, AI developer based in Lagos, Nigeria"
            width={384}
            height={384}
            fetchPriority="high"
            decoding="async"
          ...
          <div
            className="absolute top-0 left-0 w-full h-full rounded-full border-4 border-orange-600 border-t-transparent pointer-events-none"
      ...
      <div className="md:w-1/2 flex flex-col justify-center order-2 md:order-1">
        ...
        <div className="flex flex-wrap gap-4">
          <a
            href="#projects"
            className="px-6 py-3 bg-orange-600 text-white rounded-lg hover:bg-orange-500 transition min-h-11 inline-flex items-center"
          >
          ...
          <a
            href="#contact"
            className="px-6 py-3 border border-orange-600 text-orange-600 rounded-lg hover:bg-orange-50 transition min-h-11 inline-flex items-center"
          >
