            ...
            <div className="bg-linear-to-br from-orange-600 to-orange-700 p-8 rounded-xl shadow-xl text-white">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  <Mail className="w-6 h-6 mt-1 shrink-0" aria-hidden="true" />
                  <div>
                    <p className="font-semibold">Email</p>
                    <a
                      href="mailto:ogorpaul877@gmail.com"
                      className="text-orange-100 underline-offset-2 hover:underline"
                    >
                      ogorpaul877@gmail.com
                    </a>
                  </div>
                </div>

                <div className="flex items-start gap-3">
                  <MapPin className="w-6 h-6 mt-1 shrink-0" aria-hidden="true" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <Phone className="w-6 h-6 mt-1 shrink-0" aria-hidden="true" />
                  <div>
                    <p className="font-semibold">Phone</p>
                    <a
                      href="tel:+2349019978821"
                      className="text-orange-100 underline-offset-2 hover:underline"
                    >
                      +234 901 997 8821
                    </a>
              ...
              <div className="relative">
                <button
                  ...
                  aria-haspopup="menu"
                  className="w-full bg-white text-orange-600 px-6 py-3 rounded-lg font-semibold hover:bg-orange-50 transition-all duration-300 flex items-center justify-center gap-2 shadow-lg min-h-11"
                >
            ...
            <div className="bg-orange-50 p-6 rounded-xl">
              ...
              <div className="flex flex-wrap gap-3">
                <a
                  ...
                  target="_blank"
                  aria-label="Tunji Paul on X"
                  className="w-11 h-11 bg-orange-600 text-white rounded-full flex items-center justify-center hover:bg-orange-500 transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Tunji Paul on Instagram"
                  className="w-11 h-11 bg-orange-600 text-white rounded-full flex items-center justify-center hover:bg-orange-500 transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Tunji Paul on LinkedIn"
                  className="w-11 h-11 bg-orange-600 text-white rounded-full flex items-center justify-center hover:bg-orange-500 transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Tunji Paul on GitHub"
                  className="w-11 h-11 bg-orange-600 text-white rounded-full flex items-center justify-center hover:bg-orange-500 transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Tunji Paul on Medium"
                  className="w-11 h-11 bg-orange-600 text-white rounded-full flex items-center justify-center hover:bg-orange-500 transition-colors"
                >
                  <SiMedium className="w-5 h-5" aria-hidden="true" />
                </a>
              </div>
            </div>
          </div>
