...
allowed_origins = os.getenv(
    "ALLOWED_ORIGINS",
    "http://localhost:5173,http://localhost:3000,http://localhost:5174,https://tunji-paul-portfolio.vercel.app,https://tunjipaul.tech,https://www.tunjipaul.tech,http://127.0.0.1:5173,http://127.0.0.1:3000",
)
